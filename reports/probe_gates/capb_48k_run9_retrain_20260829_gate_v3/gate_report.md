...
| square_50hz | canonical | plateau_rms_after | 7.114e-05 | 0.0005 | absolute | PASS |
| square_50hz | canonical | plateau_p2p_after | 0.0006304 | 0.00158 | absolute | PASS |
| square_50hz | canonical | overshoot_after | 0.02422 | 0.07179 | relative | PASS |
| square_100hz | canonical | plateau_rms_after | 7.114e-05 | 0.0005 | absolute | PASS |
| square_100hz | canonical | plateau_p2p_after | 0.0006304 | 0.00158 | absolute | PASS |
...
| dc_step_up | canonical | plateau_rms_after | 7.114e-05 | 0.0005 | absolute | PASS |
| dc_step_up | canonical | plateau_p2p_after | 0.0006304 | 0.001951 | relative | PASS |
| dc_step_up | canonical | overshoot_after | 0.02422 | 0.07179 | relative | PASS |
| dc_step_down | canonical | plateau_rms_after | 7.404e-05 | 0.0005 | absolute | PASS |
| dc_step_down | canonical | plateau_p2p_after | 0.0006561 | 0.001951 | relative | PASS |
| dc_step_down | canonical | overshoot_after | 0.02423 | 0.07179 | relative | PASS |
| square_73hz_held | held_out | plateau_rms_after | 7.29e-05 | 0.0005 | absolute | PASS |
| square_73hz_held | held_out | plateau_p2p_after | 0.0006465 | 0.00158 | absolute | PASS |
| square_73hz_held | held_out | overshoot_after | 0.02422 | 0.07179 | relative | PASS |
| square_331hz_held | held_out | plateau_rms_after | 4.703e-05 | 0.0005 | absolute | PASS |
| square_331hz_held | held_out | plateau_p2p_after | 0.0004223 | 0.00158 | absolute | PASS |
...
| square_4400hz_held | held_out | plateau_rms_after | 0.5476 | 0.5631 | relative | PASS |
| square_4400hz_held | held_out | plateau_p2p_after | 1.053 | 1.247 | relative | PASS |
| square_4400hz_held | held_out | overshoot_after | 0.172 | 0.283 | relative | PASS |
...
## G3_mirror: PASS (worst: sweep_log_30_19k_held)

| probe | tier | metric | value | threshold | binding | pass |
|---|---|---|---|---|---|---|
| sweep_log_20_20k | canonical | image_rel_db | -96.4 | -65 | absolute | PASS |
| sweep_log_20_20k | canonical | image_peak_rel_db | -85.09 | -65 | absolute | PASS |
...
| sweep_log_30_19k_held | held_out | image_rel_db | -95.86 | -65 | absolute | PASS |
| sweep_log_30_19k_held | held_out | image_peak_rel_db | -84.8 | -65 | absolute | PASS |
...
| probe | tier | metric | value | threshold | binding | pass |
|---|---|---|---|---|---|---|
| pink_noise_s1234 | canonical | flatness_dip_db | 2.591e-05 | 1 | absolute | PASS |
...
| multitone_60_s20260704 | canonical | flatness_dip_db | 5.148e-05 | 1 | absolute | PASS |
| multitone_60_s20260704 | canonical | flatness_boost_db | 2.367e-05 | 1 | absolute | PASS |
| multitone_60_s20260704 | canonical | flatness_hf_dip_db | 0.0001026 | 3 | absolute | PASS |
| pink_noise_s5678_held | held_out | flatness_dip_db | 2.575e-05 | 1 | absolute | PASS |
...
| impulse | canonical | abs_gain_error_db | 0.009053 | 0.5 | absolute | PASS |
...
| sweep_log_20_20k | canonical | abs_gain_error_db | 1.929e-05 | 0.5 | absolute | PASS |
...
| square_4400hz_held | held_out | abs_gain_error_db | 0.2886 | 0.5 | absolute | PASS |
| tone_burst_3700hz_held | held_out | abs_gain_error_db | 0.001056 | 0.5 | absolute | PASS |
| sweep_log_30_19k_held | held_out | abs_gain_error_db | 0.0006535 | 0.5 | absolute | PASS |
...
| probe | tier | metric | value | threshold | binding | pass |
|---|---|---|---|---|---|---|
| square_50hz | canonical | added_hf_db | 0.08418 | 3 | relative | PASS |
| square_100hz | canonical | added_hf_db | 0.08365 | 3 | relative | PASS |
...
| square_5000hz | canonical | added_hf_db | -0.05061 | 3 | relative | PASS |
| square_500hz_a005 | canonical | added_hf_db | 0.1302 | 3 | relative | PASS |
| dc_step_up | canonical | added_hf_db | 0.08294 | 3 | relative | PASS |
| dc_step_down | canonical | added_hf_db | 0.07743 | 3 | relative | PASS |
| impulse | canonical | added_hf_db | -76.74 | 3 | absolute | PASS |
| impulse_train_10ms | canonical | added_hf_db | -76.67 | 3 | absolute | PASS |
| tone_burst_1000hz | canonical | added_hf_db | 55.89 | 3 | absolute | PASS |
| tone_burst_10000hz | canonical | added_hf_db | -42.38 | 3 | absolute | PASS |
| tone_burst_19000hz | canonical | added_hf_db | -73.06 | 3 | absolute | PASS |
| sweep_log_20_20k | canonical | added_hf_db | -4.79 | 3 | absolute | PASS |
| pink_noise_s1234 | canonical | added_hf_db | -71.72 | 3 | absolute | PASS |
| multitone_60_s20260704 | canonical | added_hf_db | -68.1 | 3 | absolute | PASS |
| square_73hz_held | held_out | added_hf_db | 0.0851 | 3 | relative | PASS |
...
| square_4400hz_held | held_out | added_hf_db | -0.4262 | 3 | relative | PASS |
| tone_burst_3700hz_held | held_out | added_hf_db | 6.743 | 3 | absolute | PASS |
| tone_burst_14300hz_held | held_out | added_hf_db | -61.91 | 3 | absolute | PASS |
| sweep_log_30_19k_held | held_out | added_hf_db | -2.737 | 3 | absolute | PASS |
