...
| square_73hz_held | held_out | plateau_rms_after | 1.502e-05 | 0.0005 | absolute | PASS |
...
| square_331hz_held | held_out | plateau_p2p_after | 0.0001188 | 0.00158 | absolute | PASS |
...
| probe | tier | metric | value | threshold | binding | pass |
|---|---|---|---|---|---|---|
| impulse | canonical | pre_echo_energy_after | 2.473e-07 | 2.5e-07 | absolute | PASS |
| impulse_train_10ms | canonical | pre_echo_energy_after | 2.473e-07 | 2.5e-07 | absolute | PASS |
| tone_burst_1000hz | canonical | pre_echo_energy_after | 1.22e-16 | 2.5e-07 | absolute | PASS |
| tone_burst_10000hz | canonical | pre_echo_energy_after | 2.347e-16 | 2.5e-07 | absolute | PASS |
| tone_burst_19000hz | canonical | pre_echo_energy_after | 3.009e-14 | 2.5e-07 | absolute | PASS |
| tone_burst_3700hz_held | held_out | pre_echo_energy_after | 1.156e-16 | 2.5e-07 | absolute | PASS |
| tone_burst_14300hz_held | held_out | pre_echo_energy_after | 8.283e-16 | 2.5e-07 | absolute | PASS |
...
| probe | tier | metric | value | threshold | binding | pass |
|---|---|---|---|---|---|---|
| pink_noise_s1234 | canonical | flatness_dip_db | 2.516e-05 | 1 | absolute | PASS |
| pink_noise_s1234 | canonical | flatness_boost_db | 1.055e-06 | 1 | absolute | PASS |
| pink_noise_s1234 | canonical | flatness_hf_dip_db | 1.326e-05 | 3 | absolute | PASS |
| multitone_60_s20260704 | canonical | flatness_dip_db | 4.858e-05 | 1 | absolute | PASS |
| multitone_60_s20260704 | canonical | flatness_boost_db | 2.981e-05 | 1 | absolute | PASS |
| multitone_60_s20260704 | canonical | flatness_hf_dip_db | 0.0001012 | 3 | absolute | PASS |
| pink_noise_s5678_held | held_out | flatness_dip_db | 2.526e-05 | 1 | absolute | PASS |
| pink_noise_s5678_held | held_out | flatness_boost_db | 1.043e-06 | 1 | absolute | PASS |
| pink_noise_s5678_held | held_out | flatness_hf_dip_db | 1.453e-05 | 3 | absolute | PASS |
...
| impulse_train_10ms | canonical | abs_gain_error_db | 0.02153 | 0.5 | absolute | PASS |
| tone_burst_1000hz | canonical | abs_gain_error_db | 0.001175 | 0.5 | absolute | PASS |
| sweep_log_20_20k | canonical | abs_gain_error_db | 0.001264 | 0.5 | absolute | PASS |
...
| sweep_log_30_19k_held | held_out | abs_gain_error_db | 0.001918 | 0.5 | absolute | PASS |
...
| impulse | canonical | added_hf_db | -76.69 | 3 | absolute | PASS |
| impulse_train_10ms | canonical | added_hf_db | -76.6 | 3 | absolute | PASS |
| tone_burst_1000hz | canonical | added_hf_db | 56.31 | 3 | absolute | PASS |
| tone_burst_10000hz | canonical | added_hf_db | -41.69 | 3 | absolute | PASS |
| tone_burst_19000hz | canonical | added_hf_db | -72.97 | 3 | absolute | PASS |
| sweep_log_20_20k | canonical | added_hf_db | -24.43 | 3 | absolute | PASS |
...
| square_4400hz_held | held_out | added_hf_db | 0.1865 | 3 | relative | PASS |
| tone_burst_3700hz_held | held_out | added_hf_db | 7.354 | 3 | absolute | PASS |
| tone_burst_14300hz_held | held_out | added_hf_db | -62.37 | 3 | absolute | PASS |
...
| imd_83hz_6311hz_held | held_out | added_hf_db | -7.882 | 3 | absolute | PASS |
...
| multitone_60_s20260704 | canonical | lb_group_delay_error_samples | 0.1833 | 600 | absolute | PASS |
...
| pink_noise_s5678_held | held_out | lb_group_delay_error_samples | 0.9319 | 600 | absolute | PASS |
...
| probe | tier | metric | value | threshold | binding | pass |
|---|---|---|---|---|---|---|
| imd_60hz_7000hz | canonical | modulation_sideband_db | -143 | -110 | absolute | PASS |
| imd_83hz_6311hz_held | held_out | modulation_sideband_db | -155.2 | -110 | absolute | PASS |
