...
| square_73hz_held | held_out | plateau_rms_after | 1.504e-05 | 0.0005 | absolute | PASS |
| square_73hz_held | held_out | plateau_p2p_after | 0.0001188 | 0.00158 | absolute | PASS |
...
| probe | tier | metric | value | threshold | binding | pass |
|---|---|---|---|---|---|---|
| impulse | canonical | pre_echo_energy_after | 1.523e-08 | 2.5e-07 | absolute | PASS |
| impulse_train_10ms | canonical | pre_echo_energy_after | 1.523e-08 | 2.5e-07 | absolute | PASS |
| tone_burst_1000hz | canonical | pre_echo_energy_after | 4.112e-18 | 2.5e-07 | absolute | PASS |
| tone_burst_10000hz | canonical | pre_echo_energy_after | 1.886e-17 | 2.5e-07 | absolute | PASS |
| tone_burst_19000hz | canonical | pre_echo_energy_after | 2.496e-15 | 2.5e-07 | absolute | PASS |
| tone_burst_3700hz_held | held_out | pre_echo_energy_after | 8.903e-18 | 2.5e-07 | absolute | PASS |
| tone_burst_14300hz_held | held_out | pre_echo_energy_after | 9.289e-18 | 2.5e-07 | absolute | PASS |
...
| probe | tier | metric | value | threshold | binding | pass |
|---|---|---|---|---|---|---|
| pink_noise_s1234 | canonical | flatness_dip_db | 2.51e-05 | 1 | absolute | PASS |
| pink_noise_s1234 | canonical | flatness_boost_db | 1.201e-06 | 1 | absolute | PASS |
| pink_noise_s1234 | canonical | flatness_hf_dip_db | 1.582e-05 | 3 | absolute | PASS |
| multitone_60_s20260704 | canonical | flatness_dip_db | 5.06e-05 | 1 | absolute | PASS |
| multitone_60_s20260704 | canonical | flatness_boost_db | 2.741e-05 | 1 | absolute | PASS |
| multitone_60_s20260704 | canonical | flatness_hf_dip_db | 0.000104 | 3 | absolute | PASS |
| pink_noise_s5678_held | held_out | flatness_dip_db | 2.523e-05 | 1 | absolute | PASS |
| pink_noise_s5678_held | held_out | flatness_boost_db | 1.047e-06 | 1 | absolute | PASS |
| pink_noise_s5678_held | held_out | flatness_hf_dip_db | 1.712e-05 | 3 | absolute | PASS |
...
| square_100hz | canonical | abs_gain_error_db | 0.007264 | 0.5 | absolute | PASS |
...
| dc_step_up | canonical | abs_gain_error_db | 0.0156 | 0.5 | absolute | PASS |
| dc_step_down | canonical | abs_gain_error_db | 0.0156 | 0.5 | absolute | PASS |
| impulse | canonical | abs_gain_error_db | 0.3869 | 0.5 | absolute | PASS |
| impulse_train_10ms | canonical | abs_gain_error_db | 0.3902 | 0.5 | absolute | PASS |
| tone_burst_1000hz | canonical | abs_gain_error_db | 0.001175 | 0.5 | absolute | PASS |
| sweep_log_20_20k | canonical | abs_gain_error_db | 0.0004725 | 0.5 | absolute | PASS |
| pink_noise_s1234 | canonical | abs_gain_error_db | 0.001424 | 0.5 | absolute | PASS |
...
| tone_burst_3700hz_held | held_out | abs_gain_error_db | 0.001066 | 0.5 | absolute | PASS |
| sweep_log_30_19k_held | held_out | abs_gain_error_db | 0.001245 | 0.5 | absolute | PASS |
...
| impulse | canonical | added_hf_db | -2.342 | 3 | relative | PASS |
| impulse_train_10ms | canonical | added_hf_db | -2.44 | 3 | relative | PASS |
| tone_burst_1000hz | canonical | added_hf_db | 56.25 | 3 | absolute | PASS |
| tone_burst_10000hz | canonical | added_hf_db | -41.75 | 3 | absolute | PASS |
| tone_burst_19000hz | canonical | added_hf_db | -57.01 | 3 | absolute | PASS |
| sweep_log_20_20k | canonical | added_hf_db | -24.47 | 3 | absolute | PASS |
| pink_noise_s1234 | canonical | added_hf_db | -71.46 | 3 | absolute | PASS |
| multitone_60_s20260704 | canonical | added_hf_db | -67.95 | 3 | absolute | PASS |
| imd_60hz_7000hz | canonical | added_hf_db | -11.43 | 3 | absolute | PASS |
| square_73hz_held | held_out | added_hf_db | 0.1829 | 3 | relative | PASS |
...
| tone_burst_3700hz_held | held_out | added_hf_db | 7.33 | 3 | absolute | PASS |
| tone_burst_14300hz_held | held_out | added_hf_db | -36.21 | 3 | absolute | PASS |
| sweep_log_30_19k_held | held_out | added_hf_db | -22.83 | 3 | absolute | PASS |
...
| probe | tier | metric | value | threshold | binding | pass |
|---|---|---|---|---|---|---|
| imd_60hz_7000hz | canonical | modulation_sideband_db | -144.4 | -110 | absolute | PASS |
| imd_83hz_6311hz_held | held_out | modulation_sideband_db | -157.3 | -110 | absolute | PASS |
