...
- `44k1`: `/tmp/capb_longfir_ft_44_long_sharp_1023_a140_s1234/capb_best.pt`
...
| SMPTE IMD, 60 Hz + 7 kHz | -138.07 dB | -138.22 dB |
| CCIF IMD, 19 + 20 kHz | -152.64 dB | -140.85 dB |
| Strongest added 10 kHz AM sideband | -142.55 dB | -157.00 dB |

Both checkpoints are below the unchanged -110 dB
SMPTE modulation-sideband gate. The 48 kHz result is 0.16 dB
